...
from src.mcscript.data import getBlocks
...
if __name__ == '__main__':
    print("\n".join(str(i) for i in Blocks.getBlocks()))
    print("-" * 16)
    theBlock = Blocks.findBlockByName("white_bed")
    perm = []
    for perm in theBlock.getBlockstatePermutations():
        print(perm)
    print(Blockstate.getBlockstateString(*perm))
