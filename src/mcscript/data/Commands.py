...
from src.mcscript.utils.CommandFormatter import CommandFormatter
...
if __name__ == '__main__':
    print(Command.SET_VALUE(stack=".expr1", value="1"))
    print(Command.LOAD_VARIABLE(stack=".expr1", var="a"))
    print(Command.SET_VARIABLE(struct=Struct.VAR(var="a", value=1)))
    print(Command.SET_VARIABLE_FROM(var="a", command=Command.GET_SCOREBOARD_VALUE(stack=".expr1")))
    print(Command.EXECUTE(
        sub=ExecuteCommand.AS(
            target=Selector.ALL_PLAYERS(),
